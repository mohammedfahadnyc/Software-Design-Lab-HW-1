...
public class MyCanvas extends Application {
    ...
    private void drawMyShapes(GraphicsContext graphicsCtx) {
        ...
        MyOval myOval3 = new MyOval(center, canvasWidth * width3, canvasLength * length3, MyColor.ORANGE);
...
//        // Draws horizontal line in center
//        MyLine myLine3 = new MyLine(0,  canvasLength/2, (int)canvasWidth,  (int)canvasLength/2, MyColor.BLACK);
//        myLine3.draw(graphicsCtx);

//        // Draws vertical line in center
//        MyLine myLine4 = new MyLine(canvasWidth/2,  0, (int)canvasWidth/2,  (int)canvasLength, MyColor.BLACK);
//        myLine4.draw(graphicsCtx);
    }
}
